...
#### 3.2.3百分位计算方法
**数据准备**
- 根据3.2.2计算出各个指标所需要的指标真实值
- 找同行公司，ARR应用季末最后一个月的ARR去匹配（如：一季度用三月），而非Closed month
- 找到同行公司，根据3.2.2计算出各个指标所需要的指标值
- 根据以下计算方法计算百分位排名
...
指标名称
- Actual值
- Internal Peers: 百分位值 百分位变化（↓ ↑ 无,跟上个季度报告对比，若无上个季度报告，则无变化即可 ）
- High Alpha [Edition]:百分位值 百分位变化（↓ ↑ 无，跟上个季度报告对比，若无上个季度报告，则无变化即可 ）
- Benchmarkit.ai [Edition]:百分位值 百分位变化（↓ ↑ 无，跟上个季度报告对比，若无上个季度报告，则无变化即可 ）
- Keybanc [Edition]:百分位值 百分位变化（↓ ↑ 无，跟上个季度报告对比，若无上个季度报告，则无变化即可 ）
---
